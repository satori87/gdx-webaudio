...
public class ExampleLauncher extends ApplicationAdapter {
    ...
    private final String[] exampleNames = {
        "1. Basic Playback (Load & Play Files)",
        "2. Sound Board (12 Sound Effects)",
        "3. Format Showcase (WAV/MP3/OGG/FLAC/M4A/WebM)",
        "4. Synthesizer (Oscillators + ADSR)",
        "5. Waveforms & Noise (Sine/Sq/Saw/Tri/Noise)",
        "6. Playback Control (Pitch/Rate/Fade/Loop)",
        "7. Mixing Bus / Ducking / Channels",
        "8. Effect Chain (Filter/Delay/Distortion)",
        "9. 2D Spatial Audio",
        "10. 3D Spatial Audio",
        "11. Audio Visualizer (FFT — all 4 data methods)",
        "12. Dynamic Music (Crossfade Layers)",
        "13. Rhythm Game (Precise Scheduling)",
        "14. Offline Rendering",
        "15. AudioWorklet (Custom DSP)",
        "16. AudioParam Automation (all methods)",
        "17. Filter Showcase (8 Biquad types + IIR)",
